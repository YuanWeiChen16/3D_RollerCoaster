	...
	: QMainWindow(parent)
{
	...
	connect(ui.comboBox_shader, SIGNAL(currentIndexChanged(QString)), this, SLOT(ChangeshaderType(QString)));
	connect(ui.comboBox_Path, SIGNAL(currentIndexChanged(QString)), this, SLOT(ChangesPath(QString)));
	connect(ui.comboBox_textureShader, SIGNAL(currentIndexChanged(QString)), this, SLOT(ChangesTexture(QString)));
	connect(ui.comboBox_frameBuffer, SIGNAL(currentIndexChanged(QString)), this, SLOT(ChangesFrameBuffer(QString)));
...
{
	this->trainview->speed = float(val)*2;
}
...
void AppMain::ChangeshaderType(QString type)
{
	if (type == "Partical")
	{
		this->trainview->particleC = 0;
	}
	else if (type == "noParticle")
	{
		this->trainview->particleC = 1;
	}
	else if (type == "train1")
	{
		this->trainview->particleC = 2;
	}
	else if (type == "train2") 
	{
		this->trainview->particleC = 3;
	}
}

void AppMain::ChangesPath(QString type)
{
	if (type == "Path1")
	{
		this->trainview->pathControl = 0;
	}
	else if (type == "Path2")
	{
		this->trainview->pathControl = 1;
	}

}

void AppMain::ChangesTexture(QString type)
{
	if (type == "Texture")
	{
		this->trainview->textureShader = 0;
	}
	else if (type == "Texture+Light")
	{
		this->trainview->textureShader = 1;
	}
	else if (type == "Gold+Light")
	{
		this->trainview->textureShader = 2;
	}
	else if (type == "Gold+toon")
	{
		this->trainview->textureShader = 3;
	}
	else if (type == "Texture+toon")
	{
		this->trainview->textureShader = 4;
	}
}

void AppMain::ChangesFrameBuffer(QString type)
{
	if (type == "None")
	{
		this->trainview->frameBuffer = 0;
	}
	else if (type == "fishEye")
	{
		this->trainview->frameBuffer = 1;
	}
	else if (type == "Sharp")
	{
		this->trainview->frameBuffer = 2;
	}
	else if (type == "Quantification")
	{
		this->trainview->frameBuffer = 3;
	}
	else if (type == "Mosaic")
	{
		this->trainview->frameBuffer = 4;
	}
	else if (type == "trick")
	{
		this->trainview->frameBuffer = 5;
	}
}
