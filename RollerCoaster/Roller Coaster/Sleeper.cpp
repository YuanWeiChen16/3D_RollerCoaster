...
void Sleeper::DimensionTransformation(GLfloat source[], GLfloat target[][4])
{
...
void Sleeper::Paint(GLfloat* ProjectionMatrix, GLfloat* ModelViewMatrix, Pnt3f controlP1, Pnt3f controlP2, Pnt3f controlP3, Pnt3f controlP4, Pnt3f orientP1, Pnt3f orientP2, Pnt3f orientP3, Pnt3f orientP4, int curveType, float ratio,float ratio2)
{
...
void Sleeper::Init(int divide, CTrack* track)
{
	divide_line = divide;
	track_p = track;
	InitShader("./Shader/Sleeper.vs", "./Shader/Sleeper.fs");
	InitVAO();
	InitVBO();
}
void Sleeper::InitVAO()
{
...
void Sleeper::InitShader(QString vertexShaderPath, QString fragmentShaderPath)
{
	// Create Shader
