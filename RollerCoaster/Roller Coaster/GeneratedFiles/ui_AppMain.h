...
public:
    ...
    QSlider *sSpeed;
    QComboBox *comboBox_textureShader;
    QComboBox *comboBox_frameBuffer;
...
"}"));
        ...
        comboBox_shader = new QComboBox(centralWidget);
        comboBox_shader->setObjectName(QStringLiteral("comboBox_shader"));

        horizontalLayout->addWidget(comboBox_shader);

        comboBox_Path = new QComboBox(centralWidget);
        comboBox_Path->setObjectName(QStringLiteral("comboBox_Path"));
...
" }"));
        ...
        comboBox_textureShader = new QComboBox(centralWidget);
        comboBox_textureShader->setObjectName(QStringLiteral("comboBox_textureShader"));

        horizontalLayout_2->addWidget(comboBox_textureShader);

        comboBox_frameBuffer = new QComboBox(centralWidget);
        comboBox_frameBuffer->setObjectName(QStringLiteral("comboBox_frameBuffer"));

        horizontalLayout_2->addWidget(comboBox_frameBuffer);
    ...
    void retranslateUi(QMainWindow *AppMainClass)
    {
        ...
        comboBox_shader->clear();
        comboBox_shader->insertItems(0, QStringList()
         << QApplication::translate("AppMainClass", "Partical", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "noParticle", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "train1", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "train2", Q_NULLPTR)
        );
        comboBox_Path->clear();
        comboBox_Path->insertItems(0, QStringList()
         << QApplication::translate("AppMainClass", "Path1", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Path2", Q_NULLPTR)
        );
        comboBox_textureShader->clear();
        comboBox_textureShader->insertItems(0, QStringList()
         << QApplication::translate("AppMainClass", "Texture", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Texture+Light", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Gold+Light", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Gold+toon", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Texture+toon", Q_NULLPTR)
        );
        comboBox_frameBuffer->clear();
        comboBox_frameBuffer->insertItems(0, QStringList()
         << QApplication::translate("AppMainClass", "None", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "fishEye", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Sharp", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Quantification", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "Mosaic", Q_NULLPTR)
         << QApplication::translate("AppMainClass", "trick", Q_NULLPTR)
        );
