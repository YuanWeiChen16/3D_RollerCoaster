...
void Track::DimensionTransformation(GLfloat source[], GLfloat target[][4])
{
...
void Track::Paint(GLfloat* ProjectionMatrix, GLfloat* ModelViewMatrix)
{
	GLfloat P[4][4];
	GLfloat MV[4][4];
...
void Track::Init()
{
	InitShader("./Shader/Track.vs", "./Shader/Track.fs");
	InitVAO();
	InitVBO();
	//InitTexture();
}
...
void Track::InitShader(QString vertexShaderPath, QString fragmentShaderPath)
{
	// Create Shader
